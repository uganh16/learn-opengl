...
static Mesh loadCubeMesh(void) {
  ...
  return Mesh(std::vector<Vertex>{
    ...
    { TextureLoader::load("assets/textures/container.jpg"), false, "texture0" }
  });
}

SkyboxApp::SkyboxApp(void)
  : shaderProgram(ShaderProgram::create(
    "assets/shaders/defaultShader.vs",
    "assets/shaders/defaultShader.fs"))
...
void SkyboxApp::update(float deltaTime) {
